...
function SimpleRequest(props){
  ...
  return <div><b>Requester:</b> {props.request.requester.username} <b>Quantity:</b> {props.request.quantity}        <b>Opened:</b> {new Date(props.request.date_open).toLocaleString()} {label}</div>
}
