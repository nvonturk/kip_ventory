...
import CreateBackfillRequestForm from './CreateBackfillRequestForm'

const CreateBackfillRequestModal = React.createClass({
  getInitialState() {
    return {
      requester_comment: "",
      receipt: null,
      ...
      return (
        <Modal show={this.props.show} onHide={this.props.onHide}>
          ...
          <Modal.Footer>
            ...
            <Button bsStyle="info" bsSize="small" onClick={this.createBackfillRequest}>Request Backfill</Button>
          </Modal.Footer>
        </Modal>
      )
    }
...
export default CreateBackfillRequestModal