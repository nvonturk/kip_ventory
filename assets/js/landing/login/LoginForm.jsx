...
const LoginForm = React.createClass({
  ...
  render() {
    var scope = "scope=basic identity:netid:read";
    var identity = "client_id=kipventory";
    var redirect = "redirect_uri=https://colab-sbx-277.oit.duke.edu/app/"
    var netid_url = "https://oauth.oit.duke.edu/oauth/authorize.php?response_type=code"+"&"+identity+"&"+redirect+"&"+scope;
