...
class GetNetIDToken(generics.GenericAPIView):
    ...
    def get(self, request, format=None):
        ...
        p = {'grant_type' : 'authorization_code', 'code' : code, 'redirect_uri' : 'http://colab-sbx-277.oit.duke.edu/api/netidtoken/', 'client_id' : 'kipventory', 'client_secret' : '#4ay9FQFuAPQbv8urcj+R%kd@YtAY4@=ggUXWbuvxjMX2g3kWo'}
