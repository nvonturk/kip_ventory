# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-01-28 23:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(max_length=500)),
                ('status', models.CharField(choices=[('Waiting', 'Waiting'), ('Approved', 'Approved'), ('C', 'Complete')], default='Waiting', max_length=10)),
