# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-04-16 17:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.TextField(choices=[('Item Modification', 'Item Modification'), ('Item Creation', 'Item Creation'), ('Item Deletion', 'Item Deletion'), ('Request Item Creation', 'Request Item Creation'), ('Request Item Approval: Loan', 'Request Item Approval: Loan'), ('Request Item Approval: Disburse', 'Request Item Approval: Disburse'), ('Request Item Loan Changed to Disburse', 'Request Item Loan Changed to Disburse'), ('Request Item Loan Modify', 'Request Item Loan Modify'), ('Request Item Denial', 'Request Item Denial'), ('User Creation', 'User Creation'), ('Transaction Creation', 'Transaction Creation')])),
        ...
        migrations.AddField(
            model_name='backfillrequest',
            name='loan',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='backfill_requests', to='api.Loan'),
        ),
        migrations.AddField(
            model_name='backfillrequest',
            name='request',
