# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-03-27 02:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('Item Modification', 'Item Modification'), ('Item Creation', 'Item Creation'), ('Item Deletion', 'Item Deletion'), ('Request Item Creation', 'Request Item Creation'), ('Request Item Approval: Loan', 'Request Item Approval: Loan'), ('Request Item Approval: Disburse', 'Request Item Approval: Disburse'), ('Request Item Loan Modify', 'Request Item Loan Modify'), ('Request Item Denial', 'Request Item Denial'), ('User Creation', 'User Creation'), ('Transaction Creation', 'Transaction Creation')], max_length=50)),
        ...
        migrations.AddField(
            model_name='disbursement',
            name='loan_group',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='disbursements', to='api.LoanGroup'),
        ),
        migrations.AddField(
            model_name='disbursement',
            name='request',
